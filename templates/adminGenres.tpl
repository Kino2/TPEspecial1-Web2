  ...
  <div class="col-md-2 mt-2">
      <div class="card bg-light shadow">
        <div class="tarjeta card-body">
          ...
          <td><a href="editGenreForm/{$genre->id_genero}"><button type="button" class="btn btn-outline-primary">
          ...
          <td><a href="deleteGenre/{$genre->id_genero}"><button type="button" class="btn btn-outline-danger">
